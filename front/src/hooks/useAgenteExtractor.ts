...
import type { ContextoAgenteExtractor, ItemBorrador, MensajeChat } from '../types/agenteExtractor';

const MENSAJE_BIENVENIDA =
  'Hola, soy el agente extractor. Decime los SKUs (o nombres de producto) que querés añadir a este planograma, con los atributos que tengas — facings, nivel, espacio. Lo que no me des lo completo con valores por defecto.';
