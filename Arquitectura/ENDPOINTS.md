...
| `PATCH` | `/versiones/{id}/gondolas/orden` | Analista | CU-03-03 | Reordena las góndolas de la versión. El body envía el array de IDs en el nuevo orden. |
...
| `PATCH` | `/gondolas/{id}/niveles/orden` | Analista | CU-03-07 | Reordena los niveles de la góndola. El body envía el array de IDs en el nuevo orden. |
...
| `POST` | `/posiciones/{id}/mover` | Analista | CU-04-03 | Mueve la posición a otro nivel o a otro orden dentro del mismo nivel. El body especifica `nivel_id_destino` y `orden_destino`. |
...
| `GET` | `/posiciones/{id}/accesorios` | Analista | — | Lista los accesorios de montaje asignados a la posición. |
| `POST` | `/posiciones/{id}/accesorios` | Analista | CU-04-09 | Agrega un accesorio de montaje a la posición con nota libre. |
| `DELETE` | `/posiciones/{id}/accesorios/{accesorioId}` | Analista | — | Quita un accesorio de montaje de la posición. |
...
| Método | Ruta | Actor | CU | Descripción |
|--------|------|-------|----|-------------|
| `GET` | `/productos` | Analista | CU-04-01 / CU-05-02 | Busca productos del catálogo. Filtros: `sku`, `gtin`, `marca`, `nombre`, `subcategoria`, `categoria_nivel1`, `categoria_nivel2`, `solo_con_stock`. Paginado. |
| `GET` | `/productos/{sku}` | Analista | CU-04-02 | Retorna el detalle de un producto: dimensiones, imagen, precio, jerarquía, SKU sustituto sugerido. |
...
## 11. Sesiones de captura fotográfica *(fase siguiente — fuera del MVP)*
